"""
Experiment using Linear SVM on GM SPM data with site information (site_weight = 10000).

Results:
MAE: Mean(SD) = 6.513(0.106)
R = 0.369110133341504
...
experiment_name = 'SPM_gm_w_site_SVM_weighted_classification'  # Change here*
...
gram_matrix_path = PROJECT_ROOT / 'data' / 'gram' / 'gm_w_site.csv'
