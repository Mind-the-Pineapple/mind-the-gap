"""
Experiment using Linear SVM on WM SPM data with site information (site_weight = 10000).

Results:
MAE: Mean(SD) = 7.543(0.346)
R = 0.46780018049927274
"""
...
experiment_name = 'SPM_wm_w_site_SVM_weighted_classification'  # Change here*
...
gram_matrix_path = PROJECT_ROOT / 'data' / 'gram' / 'wm_w_site.csv'
